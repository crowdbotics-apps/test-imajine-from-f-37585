...
## Project Structure
    ...
    ├── test_imajine_from_f_37585  # Django project configurations
...
1. Clone this repo and `cd test_imajine_from_f_37585`
...
2. Clone this repo and `cd test_imajine_from_f_37585`
